...
class salaCineTests {
    ...
    var salaCine = salaDeCine("s",5,5, 6,pelicula.crearPelicula("s", 1960, "s", "s"))
    ...
    fun crearPeliculaTest(){
        val nuevaPelicula = pelicula.crearPelicula("s", 1960, "s", "s")
    ...
    @Test
    fun crearButacaTest(){
        val nuevaButaca = butaca.crearButaca("A1", "libre", TipoButaca.NORMAL)
        assertEquals(butaca("A1","libre", TipoButaca.NORMAL), nuevaButaca)
    }

    @Test
    fun crearSalaDeCineTest(){
        val nuevaSalaDeCine = salaDeCine.crearSalaDeCine("s",5,5, 6,pelicula.crearPelicula("s", 1960, "s", "s"))
        assertEquals(salaDeCine("s",5,5, 6,pelicula.crearPelicula("s", 1960, "s", "s")), nuevaSalaDeCine)
    }
